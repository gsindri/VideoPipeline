...
def create_actions_router(*, profile: Dict[str, Any]) -> APIRouter:
            ...
            "paths": {
                ...
                "/api/actions/ingest_url": {
                    "post": {
                        ...
                        "requestBody": {
                            "required": True,
                            "content": {"application/json": {"schema": {"$ref": "#/components/schemas/IngestUrlRequest"}}},
                        },
                        "responses": {
                            "200": {
                ...
                "/api/actions/analyze_full": {
                    "post": {
                        ...
                        "requestBody": {
                            "required": True,
                            "content": {"application/json": {"schema": {"$ref": "#/components/schemas/AnalyzeFullRequest"}}},
                        },
                        "responses": {
                            "200": {
                                "description": "Job created",
                ...
                "/api/actions/export_batch": {
                    "post": {
                        ...
                        "requestBody": {
                            "required": True,
                            "content": {"application/json": {"schema": {"$ref": "#/components/schemas/ExportBatchRequest"}}},
                        },
                        "responses": {
                            "200": {
                                "description": "Job created",
                ...
                "/api/actions/annotations": {
                    "post": {
                        ...
                        "requestBody": {
                            "required": True,
                            "content": {
                                "application/json": {"schema": {"$ref": "#/components/schemas/AnnotationsRequest"}}
                            },
                        },
                        "responses": {
                            "200": {
    ...
    @router.post("/ingest_url", openapi_extra={"x-openai-isConsequential": False})
    ...
    @router.post("/analyze_full", openapi_extra={"x-openai-isConsequential": False})
